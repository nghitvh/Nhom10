       ...
       QUẢN LÝ HÀNG HÓA</h1>
        ...
        <fieldset>
            ...
            <table class="tb_dvt">
                <tr class="tr_dvt" >
                    ...
                    <th style="width: 120px;" class="th_dvt">Ngày nhập</td>
        ...
        <?php foreach ($khohang as $item){ ?>
                <tr>
                    ...
                    <td class="td_dvt"><?php echo number_format($item['gianhap'], 0, ',', '.'); ?></td>
                    <td class="td_dvt">
                        <form method="post" action="xoakhohang.php">
