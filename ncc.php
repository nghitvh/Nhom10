...
<h1 style="text-align: center;background-color: #900C3F;color: white;font-size: 50px; border-width:2px; border-style:solid;">
       QUẢN LÝ HÀNG HÓA</h1>
        ...
        <fieldset>
            ...
            <div class="div" ><a href="themncc.php" style="color: white;">Thêm nhà cung cấp</a></div>
            <table class="tb_dvt">
                <tr class="tr_dvt" >
                    <th class="th_dvt">Mã nhà cung cấp</td>
                    <th class="th_dvt">Tên nhà cung cấp</td>
                    <th class="th_dvt">Thao tác</td>
                </tr>
                <?php foreach ($ncc as $item){ ?>
                <tr>
                    <td class="td_dvt"><?php echo $item['mancc']; ?></td>
                    <td class="td_dvt"><?php echo $item['tenncc']; ?></td>
                    <td class="td_dvt">
                        <form method="post" action="xoancc.php">
                           
                            <input id="btn" type="hidden" name="id" value="<?php echo $item['mancc']; ?>"/>
