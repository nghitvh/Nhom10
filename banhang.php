        ...
        <fieldset>
            ...
            <table class="tb_dvt">
                <tr class="tr_dvt" >
                    ...
                    <th class="th_dvt">Tổng</td>
                    <th class="th_dvt">Hạn sử dụng</td>
                    <th class="th_dvt">Mã phiếu xuất</td>
                ...
                <tr>
                    ...
                    <td class="td_dvt"><?php echo $item['maphieuxuat']; ?></td>
                    
                    <td class="td_dvt">
                        <form method="post" action="xoabanhang.php">
                            <input id="btn" onclick="window.location = 'suabanhang.php?id=<?php echo $item['masp']; ?>'" type="button" value="Sửa"/>
                            &nbsp;
